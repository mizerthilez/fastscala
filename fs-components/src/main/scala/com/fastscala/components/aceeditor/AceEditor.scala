...
trait AceEditor extends ElemWithRandomId:
  ...
  def setWrap(v: "off" | "free" | "printmargin" | Boolean | Int): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("wrap", v)}});"""
  )

  def defaultWrapMethod: Option[WrapMethod.Value] = None

  def setWrapMethod(v: WrapMethod.Value): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("wrapMethod", v)}});"""
  )

  def defaultIndentedSoftWrap: Option[Boolean] = None

  def setIndentedSoftWrap(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("indentedSoftWrap", v)}});"""
  )

  def defaultFirstLineNumber: Option[Int] = None

  def setFirstLineNumber(v: Int): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("firstLineNumber", v)}});"""
  )
  ...
  def setUseSoftTabs(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("useSoftTabs", v)}});"""
  )
  ...
  def setNavigateWithinSoftTabs(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("navigateWithinSoftTabs", v)}});"""
  )

  def defaultFoldStyle: Option[FoldStyle.Value] = None

  def setFoldStyle(v: FoldStyle.Value): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("foldStyle", v)}});"""
  )
  ...
  def setNewLineMode(v: NewLineMode.Value): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("newLineMode", v)}});"""
  )
  ...
  def setAnimatedScroll(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("animatedScroll", v)}});"""
  )

  def defaultShowInvisibles: Option[Boolean] = None

  def setShowInvisibles(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("showInvisibles", v)}});"""
  )

  def defaultShowPrintMargin: Option[Boolean] = None

  def setShowPrintMargin(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("showPrintMargin", v)}});"""
  )

  def defaultPrintMarginColumn: Option[Int] = None

  def setPrintMarginColumn(v: Int): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("printMarginColumn", v)}});"""
  )

  def defaultPrintMargin: Option[Either[Boolean, Int]] = None

  def setPrintMargin(v: Either[Boolean, Int]): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("printMargin", v)}});"""
  )
  ...
  def setFadeFoldWidgets(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("fadeFoldWidgets", v)}});"""
  )

  def defaultShowFoldWidgets: Option[Boolean] = None

  def setShowFoldWidgets(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("showFoldWidgets", v)}});"""
  )

  def defaultShowLineNumbers: Option[Boolean] = None

  def setShowLineNumbers(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("showLineNumbers", v)}});"""
  )

  def defaultDisplayIndentGuides: Option[Boolean] = None

  def setDisplayIndentGuides(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("displayIndentGuides", v)}});"""
  )

  def defaultHighlightIndentGuides: Option[Boolean] = None

  def setHighlightIndentGuides(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("highlightIndentGuides", v)}});"""
  )

  def defaultHighlightGutterLine: Option[Boolean] = None

  def setHighlightGutterLine(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("highlightGutterLine", v)}});"""
  )

  def defaultHScrollBarAlwaysVisible: Option[Boolean] = None

  def setHScrollBarAlwaysVisible(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("hScrollBarAlwaysVisible", v)}});"""
  )

  def defaultVScrollBarAlwaysVisible: Option[Boolean] = None

  def setVScrollBarAlwaysVisible(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("vScrollBarAlwaysVisible", v)}});"""
  )

  def defaultFontSize: Option[Either[String, Int]] = None

  def setFontSize(v: Either[String, Int]): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("fontSize", v)}});"""
  )
  ...
  def setScrollPastEnd(v: Int): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("scrollPastEnd", v)}});"""
  )

  def defaultFixedWidthGutter: Option[Boolean] = None

  def setFixedWidthGutter(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("fixedWidthGutter", v)}});"""
  )

  def defaultCustomScrollbar: Option[Boolean] = None

  def setCustomScrollbar(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("customScrollbar", v)}});"""
  )
  ...
  def setHasCssTransforms(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("hasCssTransforms", v)}});"""
  )

  def defaultMaxPixelHeight: Option[Int] = None

  def setMaxPixelHeight(v: Int): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("maxPixelHeight", v)}});"""
  )

  def defaultUseSvgGutterIcons: Option[Boolean] = None

  def setUseSvgGutterIcons(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("useSvgGutterIcons", v)}});"""
  )

  def defaultShowFoldedAnnotations: Option[Boolean] = None

  def setShowFoldedAnnotations(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("showFoldedAnnotations", v)}});"""
  )

  def defaultUseResizeObserver: Option[Boolean] = None

  def setUseResizeObserver(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("useResizeObserver", v)}});"""
  )
  ...
  def setDragEnabled(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("dragEnabled", v)}});"""
  )
  ...
  def setTooltipFollowsMouse(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("tooltipFollowsMouse", v)}});"""
  )
  ...
  def setSelectionStyle(v: SelectionStyle.Value): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("selectionStyle", v)}});"""
  )

  def defaultHighlightActiveLine: Option[Boolean] = None

  def setHighlightActiveLine(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("highlightActiveLine", v)}});"""
  )

  def defaultHighlightSelectedWord: Option[Boolean] = None

  def setHighlightSelectedWord(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("highlightSelectedWord", v)}});"""
  )
  ...
  def setCopyWithEmptySelection(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("copyWithEmptySelection", v)}});"""
  )

  def defaultCursorStyle: Option[CursorStyle.Value] = None

  def setCursorStyle(v: CursorStyle.Value): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("cursorStyle", v)}});"""
  )

  def defaultMergeUndoDeltas: Option[Either[Boolean, "always"]] = None

  def setMergeUndoDeltas(v: Either[Boolean, "always"]): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("mergeUndoDeltas", v)}});"""
  )

  def defaultBehavioursEnabled: Option[Boolean] = None

  def setBehavioursEnabled(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("behavioursEnabled", v)}});"""
  )

  def defaultWrapBehavioursEnabled: Option[Boolean] = None

  def setWrapBehavioursEnabled(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("wrapBehavioursEnabled", v)}});"""
  )

  def defaultEnableAutoIndent: Option[Boolean] = None

  def setEnableAutoIndent(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableAutoIndent", v)}});"""
  )

  def defaultEnableBasicAutocompletion: Option[Boolean] = None // TODO: : boolean | Completer[];

  def setEnableBasicAutocompletion(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableBasicAutocompletion", v)}});"""
  )

  def defaultEnableLiveAutocompletion: Option[Boolean] = None // TODO: : boolean | Completer[];

  def setEnableLiveAutocompletion(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableLiveAutocompletion", v)}});"""
  )

  def defaultLiveAutocompletionDelay: Option[Int] = None

  def setLiveAutocompletionDelay(v: Int): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("liveAutocompletionDelay", v)}});"""
  )

  def defaultLiveAutocompletionThreshold: Option[Int] = None

  def setLiveAutocompletionThreshold(v: Int): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("liveAutocompletionThreshold", v)}});"""
  )

  def defaultEnableSnippets: Option[Boolean] = None

  def setEnableSnippets(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableSnippets", v)}});"""
  )
  ...
  def setAutoScrollEditorIntoView(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("autoScrollEditorIntoView", v)}});"""
  )

  def defaultKeyboardHandler: Option[Either[String, Null]] = None

  def setKeyboardHandler(v: Either[String, Null]): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("keyboardHandler", v)}});"""
  )

  def defaultPlaceholder: Option[String] = None

  def setPlaceholder(v: String): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("placeholder", v)}});"""
  )

  def defaultRelativeLineNumbers: Option[Boolean] = None

  def setRelativeLineNumbers(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("relativeLineNumbers", v)}});"""
  )

  def defaultEnableMultiselect: Option[Boolean] = None

  def setEnableMultiselect(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableMultiselect", v)}});"""
  )

  def defaultEnableKeyboardAccessibility: Option[Boolean] = None

  def setEnableKeyboardAccessibility(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableKeyboardAccessibility", v)}});"""
  )

  def defaultEnableCodeLens: Option[Boolean] = None

  def setEnableCodeLens(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableCodeLens", v)}});"""
  )

  def defaultTextInputAriaLabel: Option[String] = None

  def setTextInputAriaLabel(v: String): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("textInputAriaLabel", v)}});"""
  )

  def defaultEnableMobileMenu: Option[Boolean] = None

  def setEnableMobileMenu(v: Boolean): Js = Js(
    s"""ace.edit("$elemId").setOptions({${toJson("enableMobileMenu", v)}});"""
  )

  def addCommand(cmd: FSContext => Command)(using fsc: FSContext): Js =
    import Command.{ *, given }
    import io.circe.syntax.given
    fsc.runInNewOrRenewedChildContextFor(this):
      implicit fsc => Js(s"""editor.commands.addCommand(${cmd(fsc).asJson.toString.trimQuoteInData})""")

  def currentId: Js = Js(s"""ace.edit("$elemId").currentId""")

  def onChangeClientSide(using fsc: FSContext): Js =
    JS.function1: arg =>
      Js(
        ...
        if event.id == lastId + 1 then
          ...
          event match
            ...
            case OnChangeEvent(start, end, "insert", List(text), id) if start.row == end.row =>
              val line = state(start.row)
              state(start.row) =
                line.substring(0, start.column) + text + line.substring(start.column, line.length)
            case OnChangeEvent(start, end, "insert", firstLine :: rest, id) =>
              val line = state(start.row)
              state(start.row) = line.substring(0, start.column) + firstLine
              state.insertAll(
                start.row + 1,
                rest.dropRight(1) ::: (rest.last + line.substring(start.column, line.length)) :: Nil,
              )
  ...
  def initialize()(using FSContext): Js =
    Js:
