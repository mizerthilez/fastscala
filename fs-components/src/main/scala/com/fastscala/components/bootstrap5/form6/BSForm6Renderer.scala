package com.fastscala.components.bootstrap5.form6

import scala.xml.{ Elem, NodeSeq }

import com.fastscala.components.bootstrap5.helpers.BSHelpers
import com.fastscala.components.form6.F6FormRenderer
...
abstract class BSForm6Renderer:
  ...
  implicit def multiSelectFieldRenderer: MultiSelectF6FieldRenderer =
    new MultiSelectF6FieldRenderer:
