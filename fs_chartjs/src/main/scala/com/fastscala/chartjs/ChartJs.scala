...
object ChartJsEncoders:
  ...
  implicit val ChartDatasetDataEncoder: Encoder[ChartDatasetData] =
    Encoder.instance[ChartDatasetData](_.encode())
  implicit val ChartDatasetEncoder: Encoder[ChartDataset] =
    Encoder.instance[ChartDataset](_.encode())
