...
case class ChangedField(field: F7Field)(using Seq[RenderHint]) extends F7Event

/** Requested submit by, for example, pressing return.
  */
case class RequestedSubmit(byField: F7Field)(using Seq[RenderHint]) extends F7Event
